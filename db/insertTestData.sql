...
-- users テーブルにデータを投入
INSERT INTO users (google_user_id, email, username, profile_picture, created_at, updated_at) VALUES
...
('google-123', 'Todo1', 'Fiction', 'todo', NOW(), NOW()),
('google-123', 'Todo2', 'Non-Fiction', 'in_progress',  NOW(), NOW()),
('google-123', 'Todo3', 'Science Fiction', 'completed', NOW(), NOW());
